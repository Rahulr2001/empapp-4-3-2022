...
import $ from 'jquery';
import { createLeaveRequest } from '../employee/graphql/mutations';
        ...
        // Submit button
            $('#btnreq').one( "click",function (e) {
                ...
                {  
                  ...
                  console.log(leavedate,leavedays,leavenote,leavename)
                  const updatei = async (leavedate,leavedays,leavenote,leavename) => {
                    try {
                      const value = { leavedate,leavedays,leavenote,leavename}
                      //const restaurants = [...this.state.restaurants, restaurant]
                      //this.setState({ restaurants, Name: '', Email: '', Location: '' })
                      await API.graphql(graphqlOperation(createLeaveRequest, {input: value}))
                  ...
                  updatei(leavedate,leavedays,leavenote,leavename);
                  return true;
                }  
                else {
